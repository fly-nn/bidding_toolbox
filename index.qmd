...
### Example
[](images/seam_tables/Example Table.pdf)
```{=html}
<object data="images/seam_tables/Example Table.pdf" type="application/pdf" width="100%" height="100%" style="min-height:100vh;">
</object>
```

### Monday Starts
[](images/seam_tables/Seam Tables A Monday.pdf)

```{=html}
<object data="images/seam_tables/Seam Tables A Monday.pdf" type="application/pdf" width="100%" height="100%" style="min-height:100vh;">
</object>
```

### Tuesday Starts
[](images/seam_tables/Seam Tables A Tuesday.pdf)

```{=html}
<object data="images/seam_tables/Seam Tables A Tuesday.pdf" type="application/pdf" width="100%" height="100%" style="min-height:100vh;">
</object>
```

### Wednesday Starts
[](images/seam_tables/Seam Tables A Wednesday.pdf)

```{=html}
<object data="images/seam_tables/Seam Tables A Wednesday.pdf" type="application/pdf" width="100%" height="100%" style="min-height:100vh;">
</object>
```

### Thursday Starts
[](images/seam_tables/Seam Tables A Thursday.pdf)

```{=html}
<object data="images/seam_tables/Seam Tables A Thursday.pdf" type="application/pdf" width="100%" height="100%" style="min-height:100vh;">
</object>
```

### Saturday Starts
[](images/seam_tables/Seam Tables A Saturday.pdf)

```{=html}
<object data="images/seam_tables/Seam Tables A Saturday.pdf" type="application/pdf" width="100%" height="100%" style="min-height:100vh;">
</object>
```

### Sunday Starts
[](images/seam_tables/Seam Tables A Sunday.pdf)

```{=html}
<object data="images/seam_tables/Seam Tables A Sunday.pdf" type="application/pdf" width="100%" height="100%" style="min-height:100vh;">
</object>
```
