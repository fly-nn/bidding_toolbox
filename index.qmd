...
```{=html}
<object data="images/seam_tables/Example Table.pdf" type="application/pdf" width="70%" height="100%" style="min-height:100vh;">
</object>
```
...
```{=html}
<object data="images/seam_tables/Seam Tables A Monday.pdf" type="application/pdf" width="70%" height="100%" style="min-height:100vh;">
</object>
```
...
```{=html}
<object data="images/seam_tables/Seam Tables A Tuesday.pdf" type="application/pdf" width="70%" height="100%" style="min-height:100vh;">
</object>
```
...
```{=html}
<object data="images/seam_tables/Seam Tables A Wednesday.pdf" type="application/pdf" width="70%" height="100%" style="min-height:100vh;">
</object>
```
...
```{=html}
<object data="images/seam_tables/Seam Tables A Thursday.pdf" type="application/pdf" width="70%" height="100%" style="min-height:100vh;">
</object>
```
...
```{=html}
<object data="images/seam_tables/Seam Tables A Saturday.pdf" type="application/pdf" width="70%" height="100%" style="min-height:100vh;">
</object>
```
...
```{=html}
<object data="images/seam_tables/Seam Tables A Sunday.pdf" type="application/pdf" width="70%" height="100%" style="min-height:100vh;">
</object>
```
